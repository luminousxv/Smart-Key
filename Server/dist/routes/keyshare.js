...
router.post("/main/share_key/register", (req, res) => {
    ...
    const sql2 = "update KeyInfo set Shared = ?, SharedID = ? where SerialNum = ?";
    const sql3 = "update Key_Authority set ShareID = ? where SerialNum = ?";
    const sql4 = "select * from Users where UserEmail = ?";
    const sql5 = "insert into KeyRecord (SerialNum, Time, Method, Email) values (?, ?, ?, ?)";
...
router.post("/main/share_key/delete", (req, res) => {
    ...
    const sql3 = "update KeyInfo set Shared = ?, SharedID = ? where SerialNum = ?";
    const sql4 = "insert into KeyRecord (SerialNum, Time, Method, Email) values (?, ?, ?, ?)";
